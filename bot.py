...
# The burn rate that originally justified conserving has since dropped: pr-monitor moved from
# xhigh to high, taking a window from 81% in four days to ~37% in four and a half.
try:
